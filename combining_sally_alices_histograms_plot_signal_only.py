...
load_dir_S_sally = "/project/atlas/users/sabdadin/output/llr_fits/sally/kinematic_only/sally_hidden_[50]_relu_epochs_50_bs_128/ggf_combined_signal/range_[-2, 2]_resolutions_5000"
...
num_points_sally = 10000
x_interp_sally = np.linspace(-1.2, 1.2, num_points_sally)

###########################################
load_dir_S_alice = "/project/atlas/users/sabdadin/output/llr_fits/alices_gaussian_prior_0_1.2_10000_thetas_10e7_samples_CP_odd/kinematic_only/alices_hidden_[50]_tanh_alpha_0_epochs_50_bs_128/ggf_combined_signal/range_[-0.2, 0.2]_resolutions_801"
...
####################################
load_dir_S_alices = "/project/atlas/users/sabdadin/output/llr_fits/alices_gaussian_prior_0_1.2_10000_thetas_10e7_samples_CP_odd/kinematic_only/alices_hidden_[50]_tanh_alpha_1_epochs_50_bs_128/ggf_combined_signal/range_[-0.2, 0.2]_resolutions_801"
...
plt.plot(x_interp_hist, spline_S_hist(x_interp_hist), lw=1.5, ls='--',color="#33BBEE", label=r'$\Delta \Phi_{jj} \otimes \Delta  \Phi_{ll}$')
plt.plot(x_interp_hist_1d, spline_S_hist_1d(x_interp_hist_1d), lw=1.5, ls='--',color="#ee9d33", label=r'$\Delta \Phi_{jj}$')
plt.xlim(-0.02,0.02)
plt.ylim(0,10)
...
plt.savefig("/project/atlas/users/sabdadin/output/plots/CP_odd_signal_only_all_methods.png",dpi=600,bbox_inches='tight')
